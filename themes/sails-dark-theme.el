;;; sails-dark-theme.el --- inspired by doom-dark+-theme -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup sails-dark-theme nil
...
Can be an integer to determine the exact padding."
  :group 'sails-dark-theme
  :type '(choice integer boolean))

(defcustom sails-dark-blue-modeline nil
  "If non-nil, mode-line's color will be blue instead of the default purple."
  :group 'sails-dark-theme
  :type '(choice integer boolean))

;;
(def-doom-theme sails-dark
  ...
  ((lazy-highlight :background base4 :foreground fg :distant-foreground fg :weight 'bold)
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background base2)
